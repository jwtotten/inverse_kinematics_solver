...
if __name__ == "__main__":
    ...
    # Create gait controllers using existing IK solvers
    gc_1 = GaitController(iksolver=ik_1, number_samples=50)
    gc_2 = GaitController(iksolver=ik_2, number_samples=50)
    gc_3 = GaitController(iksolver=ik_3, number_samples=50)
    gc_4 = GaitController(iksolver=ik_4, number_samples=50)
    gc_5 = GaitController(iksolver=ik_5, number_samples=50)
    gc_6 = GaitController(iksolver=ik_6, number_samples=50)

    # Set gait patterns
    for gc in [gc_1, gc_2, gc_3, gc_4, gc_5, gc_6]:
        gc.set_gait_pattern(GaitPattern.TRIPOD)

    # Plot using the gait controllers
